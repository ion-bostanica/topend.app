...
public class OpenAiExtractionAdapter implements VisionExtractionPort {

	private final ChatClient chatClient;

	private final FoodSearchTool foodSearchTool;

	public OpenAiExtractionAdapter(OpenAiChatModel chatModel, FoodSearchTool foodSearchTool) {
