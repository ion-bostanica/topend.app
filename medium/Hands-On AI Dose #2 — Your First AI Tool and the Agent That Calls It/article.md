...
*Previous: [Hands-On AI Dose #1 — Two AI Providers, One Spring Boot Endpoint](FRIEND_LINK_1)*
...
Dose #1 ([backlink](FRIEND_LINK_1)) left us with a Spring Boot 4 API talking to Claude or OpenAI behind one config switch. Today the model stops being a chatbot: it gets a **tool** — a method in our codebase it can decide to call.
